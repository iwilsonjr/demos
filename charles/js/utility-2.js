// Initialization
var localPath = "/wp-content/themes/charles/"; //Navigation
    ...
    $(".ajaxWindow").load("/contact #contactForm", function () {
      ...
      $('#contactForm').submit(function () {
        ...
        $('.requiredField').each(function () {
          //Work borrowed/modified from Trevor Davis - http://trevordavis.net/blog/wordpress-jquery-contact-form-without-a-plugin
          if ($.trim($(this).val()) == '') {
